...
#' Linear Non-competitive Inhibition Model
#'
#' @author Daniel Mak
#' 10/03/2021
#'
#' This function analyses enzyme kinetics and reports on the results, using the
#' linear non-competitive inhibition (LNCI) model.
...
LNCI = function(EK.data,plot.options,conf.level) {
  print("Starting LNCI")
  ...
  # Define model
  formu = formula(V0 ~ (Vmax*A/((1 + I/Ki)*(Km + A))))
